...
set rc [catch {
  ...
  set_property ip_repo_paths c:/Brett/School/Spring15/541/labs/project_1/project_1.cache/ip [current_project]
  set_property ip_output_repo c:/Brett/School/Spring15/541/labs/project_1/project_1.cache/ip [current_project]
  add_files -quiet C:/Brett/School/Spring15/541/labs/project_1/project_1.runs/synth_1/top.dcp
...
set rc [catch {
  ...
  if { [file exists C:/Brett/School/Spring15/541/labs/project_1/project_1.runs/synth_1/top.hwdef] } {
    catch { write_sysdef -hwdef C:/Brett/School/Spring15/541/labs/project_1/project_1.runs/synth_1/top.hwdef -bitfile top.bit -meminfo top.mmi -file top.sysdef }
  }
